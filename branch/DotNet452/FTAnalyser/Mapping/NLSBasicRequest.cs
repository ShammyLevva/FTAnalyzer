...
namespace FTAnalyzer.Mapping
{
    ...
    /// </summary>
    public class NLSBasicRequest : IRequest
    {
        ...
        public NLSBasicRequest(string urlFormatter, IEnumerable<string> serverNodes = null, string apiKey= null)
        {
        ...
        public Uri GetUri(TileInfo info)
        {
            ...
            stringBuilder.Replace(ZTag, info.Index.Level.ToString());
