...
namespace SharpMap
{
    ...
    public class Session : ISession
    {
        ...
        private CoordinateSystems.CoordinateSystemServices _coordinateSystemServices;
        ...
        /// </summary>
        public CoordinateSystems.CoordinateSystemServices CoordinateSystemServices
        {
            get
            {
        ...
        /// </summary>
        /// <param name="ICoordinateSystemRepository">The coordinate system repository class</param>
        /// <returns>A reference to this session</returns>
