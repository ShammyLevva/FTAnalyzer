...
namespace FTAnalyzer.Forms
{
    public partial class LifeLine : Form
    {
        ...
        void SplitContainerFacts_SplitterMoved(object sender, SplitterEventArgs e)
        {
            ...
            RegistrySettings.SetRegistryValue("Lifeline Facts Splitter Distance", Height - splitter.SplitterDistance, RegistryValueKind.String);
        }
        ...
        void SavePosition()
        {
            ...
            {  //only save window size if not maximised or minimised
                RegistrySettings.SetRegistryValue("Lifeline size - width", Width, RegistryValueKind.DWord);
                RegistrySettings.SetRegistryValue("Lifeline size - height", Height, RegistryValueKind.DWord);
                RegistrySettings.SetRegistryValue("Lifeline position - top", Top, RegistryValueKind.DWord);
                RegistrySettings.SetRegistryValue("Lifeline position - left", Left, RegistryValueKind.DWord);
            }
        }
