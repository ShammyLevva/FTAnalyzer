...
namespace FTAnalyzer.Forms
{
    public partial class ColourBMD : Form
    {
        ...
        {
            Application.UserAppDataRegistry.SetValue("Default Region", cbRegion.SelectedItem.ToString() ?? string.Empty);
        ...
        void MnuSaveCensusColumnLayout_Click(object sender, EventArgs e)
        {
            ...
            UIHelpers.ShowMessage("Form Settings Saved", "BMD Colour");
        }
