...
//        /// </summary>
//        private const string UrlFormatString =
//            "http://maps.googleapis.com/maps/api/staticmap?center={0},{1}&zoom={2}&size=256x256&maptype={3}&sensor=false";

//        private string _urlmaptype;
...
//            Coordinate coordinate = new Coordinate(tileInfo.Extent.CenterX, tileInfo.Extent.CenterY);
//            MapTransforms.ReverseTransform().MathTransform.Transform(coordinate);
            
//            string latitude = coordinate.X.ToString();
//            string longitude = coordinate.Y.ToString();
//            string url = string.Format(FormatProvider, UrlFormatString,
//                              latitude, longitude, _urlmaptype, tileIndex.Level);
